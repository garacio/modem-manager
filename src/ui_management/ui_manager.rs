...
use crate::terminator::Interrupted;
...
impl UiManager {
    ...
    pub async fn main_loop(self, mut state_rx: UnboundedReceiver<State>,  mut interrupt_rx: broadcast::Receiver<Interrupted>) -> anyhow::Result<Interrupted> {
        let mut app_router = {
